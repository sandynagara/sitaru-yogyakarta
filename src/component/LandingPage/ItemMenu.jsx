...
function ItemMenu({ icon, judul, keterangan = "Belum diisi", active = false, link = "/", customAction = false }) {
  ...
  return (
    <div className='p-2 flex flex-col items-center'>
      ...
      <div
        className='text-center bg-[#111926] cursor-pointer w-64 border-2 rounded-xl mt-[-40px] pt-[40px] pb-5 border-gray-200 p-2 hover:shadow-lg hover:shadow-gray-300'
        onClick={
          () => {
            if (customAction) {
              customAction()
