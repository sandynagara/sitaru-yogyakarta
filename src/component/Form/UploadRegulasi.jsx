...
function UploadRegulasi({ setUploadOpen, setBerubah, berubah }) {
    ...
    const unggahRegulasi = async () => {
        ...
        try {
            ...
            await RegulasiService.upload(data)
            setBerubah(!berubah)
            setUploadOpen(false)
            Swal.fire({
                icon: 'success',
                title: 'Regulasi berhasil ditambahkan',
                timer: 2000,
            }
            )
        } catch (err) {
            Swal.fire({
                icon: 'error',
                title: 'Maaf',
                text: 'Regulasi gagal ditambahkan',
            })
        }
    }
