...
import ToolMeasureContainer from "../ToolMeasureContainer";
...
function ToolAddressContainer({ setCenter, open, setCenterMarker }) {
  ...
  return (
    <div
      className={`ml-[60px] mt-2 flex gap-x-1 z-[997] fixed top-0 duration-500 ${
        open && open !== "Panduan"
          ? "ml-[325px] md:ml-[460px]"
          : "ml-[70px] md:ml-[210px]"
      } `}
    >
      <ListTool
      ...
      {on == "measure" && <ToolMeasureContainer />}
    </div>
  );
}
